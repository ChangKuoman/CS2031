...
class TestCaseTodoApp(unittest.TestCase):
    def setUp(self):
        ...
        self.database_name = 'todoapp10db_test'
        self.database_path = 'postgresql://{}:admin@{}/{}'.format('postgres', 'localhost:5432', self.database_name)
    ...
    def test_get_todos_failed_page_zero(self):
        res = self.client().get('/todos?page=0')
        data = json.loads(res.data)
